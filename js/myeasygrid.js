...
(function($) {
	...
	$.fn.myeasyAddData = function(data) {
		return this.each(function() {
			if (this.t)
				this.t.add_data(data);
		});
	};
	$.fn.myeasyOptions = function(settings) {
		return this.each(function() {
			if (this.t) {
				$.extend(this.st, settings);
				this.t.init();
			}
		});
	};
	$.fn.myeasyPageChange = function(page) {
		return this.each(function() {
			if (this.t) {
				this.t.page_change(page);
			}
		});
	};
	$.fn.myeasyGetCondition = function() {
		var c;
		this.each(function() {
			if (this.t) {
				c = this.t.condition;
	...
	$.fn.myeasyGetCheckValue = function() {
		var chk_value = [];
		$('input[name="ck_box"]:checked',this).each(function() {
